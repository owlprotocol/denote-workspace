...
export const transferPreapprovalProposalTemplateId =
...
// ETF template IDs
export const portfolioCompositionTemplateId =
    "#minimal-token:ETF.PortfolioComposition:PortfolioComposition";
export const mintRecipeTemplateId =
